...
export default function EditarAtleta({ navigation }) {
    ...
    <View style = {styles.centralizaView}>
      <View style = {styles.container}>
        ...
        <View style = {styles.containerTitle}>
          <Text style = {styles.title}>EDITAR ATLETA</Text>
        </View>
        ...
        <View style={styles.containerText}>
          ...
          <Pressable style={styles.buttonAD} onPress={() => navigation.navigate('AD')}>
            <Text style={styles.text}>ALTERAR DIETA</Text>
          </Pressable>

        </View>

        <Pressable style={styles.button} onPress={() => navigation.navigate('SA')}>
